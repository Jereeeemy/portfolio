            ...
            <div>
                ...
                >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '15px' }} className="center-title-icon">
                        <h2>Didactypo</h2>
                        <img src="src/img/logoDidactypo.png" alt="Logo Didactypo" className="icone" />
                    </div>
                    ...
                    <img src="src/img/didactypo.png" alt="Screenshot Didactypo" style={{ width: '100%', borderRadius: '8px' }} />
                </div>
                ...
                >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '15px', justifyContent: 'flex-end' }} className="center-title-icon">
                        <img src="src/img/safly.png" alt="Logo Safly" className="icone" />
                        <h2>Safly</h2>
                    </div>
                    <p className="glass-bg">
                    ...
                    <img src="src/img/saflyApp.png" alt="Screenshot Safly" style={{ width: '100%', borderRadius: '8px' }} />
                </div>
                ...
                >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '15px' }} className="center-title-icon">
                        ...
                        <img src="src/img/competence/power-bi.png" alt="Logo Power BI" className="icone" />
                    </div>
                    <p className="glass-bg">
                    ...
                    <img src="src/img/stats.png" alt="Screenshot Power BI" style={{ width: '100%', borderRadius: '8px' }} />
                </div>
